...
public enum MaskList {
	...
	//There are absolutely better ways of doing this than a GT Materials-esque Enum, some method of automatically scraping the wafer types would be preferable in particular
	//Use Dyes._NULL to indicate a wafer's lack of a dedicated lens instead of null, if the wafer's mask is to be generated
    ...
    HPIC("hpic", "High Power IC", 0, "", BLANK3, null), //Different, made in chemical reactor. Figure out something for this later?
    ...
    ULPIC("ulpic", "Ultra Low Power IC", 0, "", BLANK1, Dyes.dyeGreen), // Can use green for this as well as asoc, given the latter uses a different base mask
