...
public enum MaskList {
    ...
    SOC("soc", "SoC", 150, "", BLANK2, Dyes.dyeYellow, 1, 100000, 50, 16, ItemList.Circuit_Wafer_SoC.get(1), ItemList.Circuit_Silicon_Wafer, ItemList.Circuit_Silicon_Wafer2),
    ASOC("asoc", "Advanced SoC", 120, "", BLANK2, Dyes.dyeGreen, 1, 100000, 50, 16, ItemList.Circuit_Wafer_SoC2.get(1), ItemList.Circuit_Silicon_Wafer, ItemList.Circuit_Silicon_Wafer2),
    PIC("pic", "Power IC", 100, "", BLANK2, Dyes.dyeBlue, 1, 100000, 50, 16, ItemList.Circuit_Wafer_PIC.get(1), ItemList.Circuit_Silicon_Wafer),
    HPIC("hpic", "High Power IC", 80, "", BLANK3, null, 1, 100000, 50, 16, ItemList.Circuit_Wafer_HPIC.get(1), ItemList.Circuit_Silicon_Wafer), // Different, made in chemical reactor. Figure out something for
                                                        // this later?
