...
public class Synchrotron extends GT_MetaTileEntity_EnhancedMultiBlockBase<Synchrotron> implements IConstructable {
    ...
    /*
     * c: Shielded accelerator casing v: Vacuum k: Superconducting coil d:
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType("Particle Accelerator").addInfo("Controller block for the Synchrotron")
                .addInfo("Torus-shaped, accelerates electrons to produce high-energy electromagnetic radiation").toolTipFinisher("GTNH: Lanthanides");;
        return tt;
    }
